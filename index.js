...
//     let rainbowTitle = chalkAnimations.rainbow('Lets start calculating');
//     await sleep();
//     rainbowTitle.stop();
...
//     console.log(`${answers.num1} ^ ${answers.num2} = ${Math.pow(answers.num1, answers.num2)}`);
// }
// else if (answers.operator == "Cube") {
//     console.log(`Cube of ${answers.num1} = ${Math.pow(answers.num1, 3)}`);
// }
// else if (answers.operator == "Square Root") {
//     console.log(`Square Root of ${answers.num1} = ${Math.sqrt(answers.num1)}`);
// }
// })
// };
// askQuestion();
...
//                     type: "input",
//                     name: "startAgain",
//                     message: "Do you want to start again? Yes or No"
//                 }
//             ]);
//     } while (again.startAgain == 'y' || again.startAgain == 'yes' || again.startAgain == 'Yes');
// }
// startAgain ();
import inquirer from "inquirer";
import chalk from "chalk";
...
async function askQuestion() {
    ...
    } while (again.startAgain.toLowerCase() == "y" ||
